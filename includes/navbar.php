      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-6 col-lg-3">
            ...
            <img src="images/logo.png" alt="Image" class="img-fluid" style="max-width: 100px; height: 100px;">
            </a><h3>SJC Hall Booking System</h3>
          </div>
          ...
          <div class="col-lg-3 d-none d-lg-block">
            <div class="quick-contact-icons d-flex">
              ...
              <div class="text">
                <span class="h4 d-block">+0431-2700320/4226436</span>
          ...
          <div class="col-lg-3 d-none d-lg-block">
            <div class="quick-contact-icons d-flex">
              ...
              <div class="text">
                <span class="h4 d-block">college@mail.sjctni.edu</span>
