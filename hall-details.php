  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <?php 
$bid=$_GET['bid'];
$query = mysqli_query($con, "SELECT * FROM tblhall WHERE ID='$bid'");
$cnt=1;
...
?>
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <h3 class="heading-92913 text-black">Hall Details</h3>
                <p><strong>Hall Name:</Strong>  <?php echo $result['HallName'];?></p>
                <p><strong>Hall Size:</Strong>  <?php echo $result['Size'];?></p>
                <p><strong>Description: <?php echo $result['Description'];?></strong> </p>

              
              <div class="form-group col-md-12">
              
                <a href="book-hall.php?bid=<?php echo $result['ID']; ?>"  class="btn btn-primary py-3 px-5">
                 Book Now</a>
              </div>
